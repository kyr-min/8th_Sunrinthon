...
var app = (function () {
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "svelte-1s5046l");
    			...
    			attr_dev(img1, "class", "svelte-1s5046l");
    			add_location(img1, file$c, 22, 8, 677);
    			attr_dev(div5, "id", "page1_cont2");
    			attr_dev(div5, "class", "svelte-1s5046l");
    			add_location(div5, file$c, 20, 4, 577);
    			attr_dev(main, "class", "svelte-1s5046l");
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "svelte-1casggy");
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "sc5 svelte-17rx807");
    			add_location(p, file$7, 38, 28, 1373);
    			attr_dev(div0, "id", "title");
    			attr_dev(div0, "class", "svelte-17rx807");
    			add_location(div0, file$7, 38, 12, 1357);
    			add_location(div1, file$7, 37, 8, 1338);
    			attr_dev(div2, "id", "components");
    			attr_dev(div2, "class", "svelte-17rx807");
    			add_location(div2, file$7, 40, 8, 1440);
    			attr_dev(div3, "id", "contentBox");
    			attr_dev(div3, "class", "svelte-17rx807");
    			add_location(div3, file$7, 36, 4, 1307);
    			attr_dev(div4, "id", "page2");
    			attr_dev(div4, "class", "grid svelte-17rx807");
    			add_location(div4, file$7, 35, 0, 1272);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-1o84wr3");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a1 = element("a");
    			img1 = element("img");
    			attr_dev(p0, "class", "sc5 cream svelte-110pthb");
    			add_location(p0, file$1, 3, 28, 104);
    			attr_dev(div0, "id", "title");
    			attr_dev(div0, "class", "svelte-110pthb");
    			add_location(div0, file$1, 3, 12, 88);
    			attr_dev(p1, "class", "sc7 cream svelte-110pthb");
    			add_location(p1, file$1, 4, 32, 190);
    			attr_dev(div1, "id", "korTitle");
    			attr_dev(div1, "class", "svelte-110pthb");
    			add_location(div1, file$1, 4, 12, 170);
    			attr_dev(div2, "id", "textBox");
    			attr_dev(div2, "class", "svelte-110pthb");
    			add_location(div2, file$1, 2, 8, 56);
    			attr_dev(input0, "type", "radio");
    			attr_dev(input0, "name", "slide");
    			attr_dev(input0, "id", "game");
    			input0.checked = true;
    			attr_dev(input0, "class", "svelte-110pthb");
    			add_location(input0, file$1, 8, 16, 332);
    			attr_dev(input1, "type", "radio");
    			attr_dev(input1, "name", "slide");
    			attr_dev(input1, "id", "web-app");
    			attr_dev(input1, "class", "svelte-110pthb");
    			add_location(input1, file$1, 9, 16, 401);
    			attr_dev(label0, "for", "web-app");
    			attr_dev(label0, "class", "left svelte-110pthb");
    			add_location(label0, file$1, 13, 32, 609);
    			attr_dev(label1, "for", "web-app");
    			attr_dev(label1, "class", "right svelte-110pthb");
    			add_location(label1, file$1, 14, 32, 685);
    			if (!src_url_equal(img0.src, img0_src_value = "/game.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "class", "svelte-110pthb");
    			add_location(img0, file$1, 15, 35, 765);
    			attr_dev(a0, "class", "svelte-110pthb");
    			add_location(a0, file$1, 15, 32, 762);
    			attr_dev(div3, "class", "svelte-110pthb");
    			add_location(div3, file$1, 12, 28, 570);
    			attr_dev(li0, "class", "slideitem svelte-110pthb");
    			add_location(li0, file$1, 11, 24, 517);
    			attr_dev(label2, "for", "game");
    			attr_dev(label2, "class", "left svelte-110pthb");
    			add_location(label2, file$1, 20, 32, 975);
    			attr_dev(label3, "for", "game");
    			attr_dev(label3, "class", "right svelte-110pthb");
    			add_location(label3, file$1, 21, 32, 1048);
    			if (!src_url_equal(img1.src, img1_src_value = "/web-app.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "class", "svelte-110pthb");
    			add_location(img1, file$1, 22, 35, 1125);
    			attr_dev(a1, "class", "svelte-110pthb");
    			add_location(a1, file$1, 22, 32, 1122);
    			attr_dev(div4, "class", "svelte-110pthb");
    			add_location(div4, file$1, 19, 28, 936);
    			attr_dev(li1, "class", "slideitem svelte-110pthb");
    			add_location(li1, file$1, 18, 24, 883);
    			attr_dev(ul, "class", "slidelist svelte-110pthb");
    			add_location(ul, file$1, 10, 20, 469);
    			attr_dev(div5, "class", "slider svelte-110pthb");
    			add_location(div5, file$1, 7, 12, 294);
    			attr_dev(div6, "id", "borderbox");
    			attr_dev(div6, "class", "svelte-110pthb");
    			add_location(div6, file$1, 6, 8, 260);
    			attr_dev(div7, "id", "contentBox");
    			attr_dev(div7, "class", "svelte-110pthb");
    			add_location(div7, file$1, 1, 4, 25);
    			attr_dev(div8, "id", "teamlist");
    			attr_dev(div8, "class", "svelte-110pthb");
