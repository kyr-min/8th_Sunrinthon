    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			p2 = element("p");
    			p2.textContent = "Coming Soon";
    			attr_dev(p0, "class", "sc5 cream svelte-15tzs1n");
    			add_location(p0, file$1, 3, 28, 104);
    			attr_dev(div0, "id", "title");
    			attr_dev(div0, "class", "svelte-15tzs1n");
    			add_location(div0, file$1, 3, 12, 88);
    			attr_dev(p1, "class", "sc7 cream");
    			add_location(p1, file$1, 4, 32, 190);
    			attr_dev(div1, "id", "korTitle");
    			attr_dev(div1, "class", "svelte-15tzs1n");
    			add_location(div1, file$1, 4, 12, 170);
    			attr_dev(p2, "class", "sc7 cream");
    			add_location(p2, file$1, 5, 28, 264);
    			attr_dev(div2, "id", "text1");
    			attr_dev(div2, "class", "svelte-15tzs1n");
    			add_location(div2, file$1, 5, 12, 248);
    			attr_dev(div3, "id", "textBox");
    			add_location(div3, file$1, 2, 8, 56);
    			attr_dev(div4, "id", "contentBox");
    			attr_dev(div4, "class", "svelte-15tzs1n");
    			add_location(div4, file$1, 1, 4, 25);
    			attr_dev(div5, "id", "teamlist");
    			attr_dev(div5, "class", "svelte-15tzs1n");
