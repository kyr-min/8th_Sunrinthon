...
var app = (function () {
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$a, 6, 8, 78);
    			attr_dev(p1, "class", "sc7 bluegreen svelte-1uena2l");
    			add_location(p1, file$a, 7, 8, 116);
    			attr_dev(div0, "id", "textBox");
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$9, 32, 16, 733);
    			attr_dev(p1, "class", "sc5");
    			add_location(p1, file$9, 33, 16, 775);
    			attr_dev(div0, "class", "ScheduleTextBox firstText svelte-qsy0ci");
    			add_location(div0, file$9, 31, 12, 676);
    			attr_dev(object0, "class", "markerSvg svelte-qsy0ci");
    			attr_dev(object0, "type", "image/svg+xml");
    			attr_dev(object0, "data", "/svgs/markerIcon.svg");
    			attr_dev(object0, "title", "marker");
    			add_location(object0, file$9, 35, 12, 848);
    			attr_dev(div1, "class", "MarkerBox svelte-qsy0ci");
    			add_location(div1, file$9, 30, 8, 614);
    			attr_dev(p2, "class", "sc8");
    			add_location(p2, file$9, 39, 16, 1079);
    			attr_dev(p3, "class", "sc5");
    			add_location(p3, file$9, 40, 16, 1120);
    			attr_dev(div2, "class", "ScheduleTextBox svelte-qsy0ci");
    			add_location(div2, file$9, 38, 12, 1032);
    			attr_dev(object1, "class", "markerSvg svelte-qsy0ci");
    			attr_dev(object1, "type", "image/svg+xml");
    			attr_dev(object1, "data", "/svgs/markerIcon.svg");
    			attr_dev(object1, "title", "marker");
    			add_location(object1, file$9, 42, 12, 1193);
    			attr_dev(div3, "class", "MarkerBox svelte-qsy0ci");
    			add_location(div3, file$9, 37, 8, 995);
    			attr_dev(p4, "class", "sc8");
    			add_location(p4, file$9, 46, 16, 1453);
    			attr_dev(p5, "class", "sc5");
    			add_location(p5, file$9, 47, 16, 1495);
    			attr_dev(div4, "class", "ScheduleTextBox rec svelte-qsy0ci");
    			add_location(div4, file$9, 45, 12, 1401);
    			attr_dev(object2, "class", "markerSvg svelte-qsy0ci");
    			attr_dev(object2, "type", "image/svg+xml");
    			attr_dev(object2, "data", "/svgs/markerIcon.svg");
    			attr_dev(object2, "title", "marker");
    			add_location(object2, file$9, 49, 12, 1568);
    			attr_dev(div5, "class", "MarkerBox svelte-qsy0ci");
    			add_location(div5, file$9, 44, 8, 1339);
    			attr_dev(p6, "class", "sc8");
    			add_location(p6, file$9, 53, 16, 1831);
    			attr_dev(p7, "class", "sc5");
    			add_location(p7, file$9, 54, 16, 1871);
    			attr_dev(div6, "class", "ScheduleTextBox mentor svelte-qsy0ci");
    			add_location(div6, file$9, 52, 12, 1776);
    			attr_dev(object3, "class", "markerSvg svelte-qsy0ci");
    			attr_dev(object3, "type", "image/svg+xml");
    			attr_dev(object3, "data", "/svgs/markerIcon.svg");
    			attr_dev(object3, "title", "marker");
    			add_location(object3, file$9, 56, 12, 1944);
    			attr_dev(div7, "class", "MarkerBox svelte-qsy0ci");
    			add_location(div7, file$9, 51, 8, 1714);
    			attr_dev(p8, "class", "sc8");
    			add_location(p8, file$9, 60, 16, 2200);
    			attr_dev(p9, "class", "sc5");
    			add_location(p9, file$9, 61, 16, 2242);
    			attr_dev(div8, "class", "ScheduleTextBox svelte-qsy0ci");
    			add_location(div8, file$9, 59, 12, 2152);
    			attr_dev(object4, "class", "markerSvg svelte-qsy0ci");
    			attr_dev(object4, "type", "image/svg+xml");
    			attr_dev(object4, "data", "/svgs/markerIcon.svg");
    			attr_dev(object4, "title", "marker");
    			add_location(object4, file$9, 63, 12, 2315);
    			attr_dev(div9, "class", "MarkerBox svelte-qsy0ci");
    			add_location(div9, file$9, 58, 8, 2090);
    			attr_dev(p10, "class", "sc8");
    			add_location(p10, file$9, 67, 16, 2545);
    			attr_dev(p11, "class", "sc5");
    			add_location(p11, file$9, 68, 16, 2586);
    			attr_dev(div10, "class", "ScheduleTextBox svelte-qsy0ci");
    			add_location(div10, file$9, 66, 12, 2498);
    			attr_dev(object5, "class", "markerSvg svelte-qsy0ci");
    			attr_dev(object5, "type", "image/svg+xml");
    			attr_dev(object5, "data", "/svgs/markerIcon.svg");
    			attr_dev(object5, "title", "marker");
    			add_location(object5, file$9, 70, 12, 2660);
    			attr_dev(div11, "class", "MarkerBox svelte-qsy0ci");
    			add_location(div11, file$9, 65, 8, 2461);
    			attr_dev(div12, "id", "progressBarDescription");
    			attr_dev(div12, "class", "svelte-qsy0ci");
    			add_location(div12, file$9, 29, 4, 571);
    			attr_dev(div13, "id", "progressBar");
    			attr_dev(div13, "class", "svelte-qsy0ci");
    			add_location(div13, file$9, 74, 8, 2849);
    			attr_dev(span0, "class", "sc5 bluegreen svelte-qsy0ci");
    			attr_dev(span0, "id", "clickIcon");
    			add_location(span0, file$9, 76, 12, 2919);
    			attr_dev(span1, "class", "sc5 bluegreen svelte-qsy0ci");
    			attr_dev(span1, "id", "scrollMobile");
    			add_location(span1, file$9, 77, 12, 3007);
    			attr_dev(span2, "class", "sc7 bluegreen");
    			add_location(span2, file$9, 78, 12, 3088);
    			attr_dev(div14, "id", "description");
    			attr_dev(div14, "class", "svelte-qsy0ci");
    			add_location(div14, file$9, 75, 8, 2883);
    			attr_dev(div15, "id", "barDescription");
    			attr_dev(div15, "class", "svelte-qsy0ci");
    			add_location(div15, file$9, 73, 4, 2814);
    			attr_dev(div16, "id", "progWrapper");
    			attr_dev(div16, "class", "svelte-qsy0ci");
    			add_location(div16, file$9, 28, 0, 543);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div1, "click", /*changeInfo*/ ctx[2](0), false, false, false),
    					listen_dev(div5, "click", /*changeInfo*/ ctx[2](2), false, false, false),
    					listen_dev(div7, "click", /*changeInfo*/ ctx[2](3), false, false, false),
    					listen_dev(div9, "click", /*changeInfo*/ ctx[2](4), false, false, false)
    				];
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	let { formatedNow, click = 0, isOpen = false } = $$props;
    	...
    	const writable_props = ['formatedNow', 'click', 'isOpen'];
    	...
    	return [formatedNow, MissionTimeLine, changeInfo, click, isOpen];
    }

    class Schedule extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$9, safe_not_equal, { formatedNow: 0, click: 3, isOpen: 4 });
    ...
    function create_fragment$7(ctx) {
    	...
    	timer = new Timer({
    			props: {
    				formatedRemaining: /*handleUndefined*/ ctx[4](/*formatedRemaining*/ ctx[0])
    			},
    			$$inline: true
    		});
    	...
    	function schedule_click_binding(value) {
    		/*schedule_click_binding*/ ctx[5](value);
    	}

    	function schedule_isOpen_binding(value) {
    		/*schedule_isOpen_binding*/ ctx[6](value);
    	}

    	let schedule_props = {
    		formatedNow: /*handleUndefined*/ ctx[4](/*formatedNow*/ ctx[1])
    	};

    	if (/*click*/ ctx[2] !== void 0) {
    		schedule_props.click = /*click*/ ctx[2];
    	}

    	if (/*open*/ ctx[3] !== void 0) {
    		schedule_props.isOpen = /*open*/ ctx[3];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			const timer_changes = {};
    			if (dirty & /*formatedRemaining*/ 1) timer_changes.formatedRemaining = /*handleUndefined*/ ctx[4](/*formatedRemaining*/ ctx[0]);
    			timer.$set(timer_changes);
    			const markerdesccont_changes = {};
    			if (dirty & /*click*/ 4) markerdesccont_changes.currentMarker = /*click*/ ctx[2];
    			if (dirty & /*open*/ 8) markerdesccont_changes.isOpen = /*open*/ ctx[3];
    			markerdesccont.$set(markerdesccont_changes);
    			const schedule_changes = {};
    			if (dirty & /*formatedNow*/ 2) schedule_changes.formatedNow = /*handleUndefined*/ ctx[4](/*formatedNow*/ ctx[1]);

    			if (!updating_click && dirty & /*click*/ 4) {
    				updating_click = true;
    				schedule_changes.click = /*click*/ ctx[2];
    				add_flush_callback(() => updating_click = false);
    			}

    			if (!updating_isOpen && dirty & /*open*/ 8) {
    				updating_isOpen = true;
    				schedule_changes.isOpen = /*open*/ ctx[3];
