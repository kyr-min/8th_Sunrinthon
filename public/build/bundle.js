    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a1 = element("a");
    			img1 = element("img");
    			attr_dev(p0, "class", "sc5 cream svelte-klvfb0");
    			add_location(p0, file$1, 3, 28, 117);
    			attr_dev(div0, "id", "title");
    			attr_dev(div0, "class", "svelte-klvfb0");
    			add_location(div0, file$1, 3, 12, 101);
    			attr_dev(p1, "class", "sc7 cream svelte-klvfb0");
    			add_location(p1, file$1, 4, 32, 203);
    			attr_dev(div1, "id", "korTitle");
    			attr_dev(div1, "class", "svelte-klvfb0");
    			add_location(div1, file$1, 4, 12, 183);
    			attr_dev(div2, "id", "textBox");
    			attr_dev(div2, "class", "svelte-klvfb0");
    			add_location(div2, file$1, 2, 8, 69);
    			attr_dev(input0, "type", "radio");
    			attr_dev(input0, "name", "slide");
    			attr_dev(input0, "id", "game");
    			input0.checked = true;
    			attr_dev(input0, "class", "svelte-klvfb0");
    			add_location(input0, file$1, 8, 16, 345);
    			attr_dev(input1, "type", "radio");
    			attr_dev(input1, "name", "slide");
    			attr_dev(input1, "id", "web-app");
    			attr_dev(input1, "class", "svelte-klvfb0");
    			add_location(input1, file$1, 9, 16, 414);
    			attr_dev(label0, "for", "web-app");
    			attr_dev(label0, "class", "left svelte-klvfb0");
    			add_location(label0, file$1, 13, 32, 622);
    			attr_dev(label1, "for", "web-app");
    			attr_dev(label1, "class", "right svelte-klvfb0");
    			add_location(label1, file$1, 14, 32, 698);
    			if (!src_url_equal(img0.src, img0_src_value = "/game.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "class", "svelte-klvfb0");
    			add_location(img0, file$1, 15, 35, 778);
    			attr_dev(a0, "class", "svelte-klvfb0");
    			add_location(a0, file$1, 15, 32, 775);
    			attr_dev(div3, "class", "svelte-klvfb0");
    			add_location(div3, file$1, 12, 28, 583);
    			attr_dev(li0, "class", "slideitem svelte-klvfb0");
    			add_location(li0, file$1, 11, 24, 530);
    			attr_dev(label2, "for", "game");
    			attr_dev(label2, "class", "left svelte-klvfb0");
    			add_location(label2, file$1, 20, 32, 988);
    			attr_dev(label3, "for", "game");
    			attr_dev(label3, "class", "right svelte-klvfb0");
    			add_location(label3, file$1, 21, 32, 1061);
    			if (!src_url_equal(img1.src, img1_src_value = "/web-app.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "class", "svelte-klvfb0");
    			add_location(img1, file$1, 22, 35, 1138);
    			attr_dev(a1, "class", "svelte-klvfb0");
    			add_location(a1, file$1, 22, 32, 1135);
    			attr_dev(div4, "class", "svelte-klvfb0");
    			add_location(div4, file$1, 19, 28, 949);
    			attr_dev(li1, "class", "slideitem svelte-klvfb0");
    			add_location(li1, file$1, 18, 24, 896);
    			attr_dev(ul, "class", "slidelist svelte-klvfb0");
    			add_location(ul, file$1, 10, 20, 482);
    			attr_dev(div5, "class", "slider svelte-klvfb0");
    			add_location(div5, file$1, 7, 12, 307);
    			attr_dev(div6, "id", "borderbox");
    			attr_dev(div6, "class", "svelte-klvfb0");
    			add_location(div6, file$1, 6, 8, 273);
    			attr_dev(div7, "id", "contentBox");
    			attr_dev(div7, "class", "svelte-klvfb0");
    			add_location(div7, file$1, 1, 4, 38);
    			attr_dev(div8, "id", "teamlist");
    			attr_dev(div8, "class", "grid svelte-klvfb0");
